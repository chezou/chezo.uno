...
keywords: [staff, engineer, プロジェクト, エンジニア, チームメンバー, 本書, マップ, こと, 自分, 戦略]
...
この本では、先達たちの「こうしてきた」エピソードや実例、どのような考え方をもとに動くべきかといった試行錯誤を書き連ねた本だ。どのように考えて自分にとってそして会社にとっても重要なプロジェクトを選び、それをスポンサーを獲得し、メンバーが助けを求めていれば・求めていなくても西へ東へ奔走し、プロジェクトが進むためにあらゆることをする、そういったStaff+と呼ばれるエンジニアに向けての、実例集である。
...
私は社内のPrincipalの中でも、比較的戦略的・政治的な振る舞いが求められることが多く、今はSr Engineering Directorの助けを借りたり、外部からの玉を打ち返せるような支援をするみたいなことをしている。そういう時に、自分と同じようなことをしている人が少ないこともあり、どうしても孤独になりがちでGeminiと無限に壁打ちをするみたいなことが発生する。しかし、書籍は（ある程度盛っているかもしれないが）生きた人の爪痕であり、大変に支えになるのである。
