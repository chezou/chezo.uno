...
世の中の流れ的に、エージェントの制御を自前実装するよりも[Claude Codeやcodexに渡したほうが速い](https://nyosegawa.com/posts/skill-creator-and-orchestration-skill/)みたいなのが来てる感じはするけれども、その裏側でどう動いているのかを考えて設計できるようになったのは何よりだった。
